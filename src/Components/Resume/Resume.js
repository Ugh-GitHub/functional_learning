    ...
    return (
        <>
            <div>
                Peter Pierce <br/>
                (952) 491 - 0151 <br/>
                www.linkedin.com/in/peter-pierce-2b757737 <br/>
                https://github.com/Ugh-GitHub
            </div>
            
            <h1>About</h1>
            Accomplished Account Manager with over 6 years experience in managing and solutioning for two $3-5 million accounts. Currently pivoting into a software engineering role where I can leverage my aptitude for learning, problem solving and communication. You can currently find me learning Typescript and AWS, building a React Native app, improvising on stage, or bouldering.
            <h1>Experience</h1>
            February 2021 - April 2021
            <h2>Westwood Professional Services, Minnetonka, MN - Contract Technical Business Analyst</h2>
            Westwood is a multi-disciplined national surveying and engineering services provider for commercial and residential development, public infrastructure, wind energy, solar energy, energy storage, and electric transmission projects.
            <ul>
            ...
            <h2>Lyle Signs, Eden Prairie, MN - Account Manager</h2>
            Lyle Signs was a 8-figure revenue 100+ year old company and one of the industry leaders of signage
            and labelling solutions in the parking, traffic, and industrial safety markets.
            <ul>
            ...
            <h2>Lyle Signs, Eden Prairie, MN - Assistant Account Manager</h2>
            <ul>
            ...
            <h2>RAW Logistics, Edina, MN - Logistics Coordinator</h2>
            Operated a phone desk and freight tracking system for 50 hours/week.
            <ul>
                <li>Negotiated, brokered, and coordinated shipments with asset-based carriers.</li>
            </ul>
            <h1>Skills</h1>
            PERN (PostgreSQL, Express, React, and Node.js) Stack, React Native, GitHub, Javascript, SQL, HTML, Python, Axios, Ajax, Agile, Scrum, Microsoft Excel (Power User), Azure DevOps, Atlassian Trello, Xcode, Amazon Vendor Ecosystem (SEO, PPC, etc.).
            <h1>Education</h1>
            October 2020 - January 2021
            <h2>PRIME Digital Academy, Minneapolis, MN - Full Stack Software Engineering</h2>
            20-week remote intensive program learning the essentials of web app development and the Agile
            ...
            <h2>Colgate University, Hamilton, NY - Bachelor of Arts Double Major in Economics and Geography</h2>

            <h1>Volunteering</h1>
            June 2021 - Present
            <h2>Open Arms of MN - Kitchen & Bakery Volunteer</h2>
            Volunteering 1.5-2 hours per day weekly (and sometimes Saturday). Open Arms of MN strives to provide medically tailored meals for people experiencing a significant illness or health crisis. 
        </>
    );
}
